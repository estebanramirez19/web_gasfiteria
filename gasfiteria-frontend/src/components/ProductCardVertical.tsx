...
/*todo esto esta pensado en la carta de productos vertical */
...
function ProductCardVertical({ title, subtitle, description, imageUrl, price, altText,link }: ProductCardVerticalProps) {
  return (
